...
export default function View() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <Navbar>
        <Link to="/new">
          <span className="text-base text-white leading-5 font-semibold bg-indigo-600 rounded-full py-2 px-5 flex items-center space-x-2 hover:bg-indigo-800 dark:highlight-white/5">
            새 글 쓰기
          </span>
        </Link>
      </Navbar>
          ...
          <div className="group max-w-md mx-auto w-full md:w-9/12 border-gray-300 border-2 border-dashed rounded-xl overflow-hidden md:max-w-screen-lg m-6">
            <div className="md:flex">
              <div className="p-8 grow">
                <div className="block mt-10 text-lg text-center leading-tight text-gray-400 mb-10">
                  아직 게시물이 없어요. 새 글을 쓰러 가볼까요?
                </div>
              </div>
            </div>
          </div>
