...
export default function Toolbar({
  ...
  return (
    <div className="flex md:float-right mt-1 md:ml-3 my-2">
      <Link
        to={`/article/${id}/edit`}
        className="group flex items-center text-sm leading-3 font-semibold bg-gray-400/10 text-gray-600 rounded-lg py-2 px-3 mr-2 hover:bg-gray-400/40"
      >
        <svg
          height="18"
          width="18"
      ...
      >
        ...
        >
          <path
            ...
            transform="matrix(0.092, 0, 0, 0.092, 0, 0) scale(0.15)"
            fill="gray"
          ></path>
        </svg>
        삭제
